...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Player setCurrentSong={setCurrentSong} songs={songs} songInfo={songInfo} audioRef={audioRef} isPlaying={isPlaying} setIsPlaying={setIsPlaying} currentSong={currentSong} setSongInfo={setSongInfo}/>
